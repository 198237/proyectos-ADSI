<%-- 
    Document   : edit
    Created on : 10/08/2020, 06:19:39 PM
    Author     : Estiven
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container col-lg-6">
            ...
            int id = Integer.parseInt((String)request.getAttribute("idBodega"));
            Bodega bodega = dao.list(id);
            ...
            <form action="ControladorBodega" >
                ...
                <div class="form-group">
                    ...
                    <input name="txtCodigoBodega" type="text" class="form-control" value="<%=bodega.getCodigoBodega()%>">
                    <input name="txtIdBodega" type="hidden" value="<%=bodega.getIdBodega()%>">
                </div>
                <br>
                <div class="form-group">
                    <center>
                ...
                <div class="form-group">
                    ...
                    <input name="txtCantidadBodega" type="number" class="form-control" value="<%=bodega.getCantidadBodega()%>" required placeholder="Solo números">
                </div>
                <br>
